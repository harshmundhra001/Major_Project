...
function keyupEvent(e) {
  ...
  if (details.code === 'Enter') {
    if (index === 0) {
      ...
      // sendToServer();
      passwordFields[3].focus();
    
    }
    // editing here-------------------------------
    else if (index === 3) {
      passwordFields[4].focus();
    
    }else if (index === 4) {
      passwordFields[5].focus();
    
    }
    else if (index === 5) {
    
      passwordFields[6].focus();
    
    }
    else if (index === 6) {
    
      passwordFields[7].focus();
    
    }else if (index === 7) {
      
      passwordFields[8].focus();
    
    }
    else if (index === 8) {
   
      passwordFields[9].focus();
